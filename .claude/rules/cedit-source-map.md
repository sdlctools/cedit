...
for `pip install cedit` consumers too, not just source checkouts. A third,
...
perfectly fine in a GitHub preview.
...
3.10 – 3.13, but it gates nothing (see AGENTS.md) — this local run is still
the gate.
